...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/05/26 11:57:39 by aysozen           #+#    #+#             */
/*   Updated: 2023/06/22 13:27:42 by yakdik           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static inline char	*ft_new_create_buffer(char *buffer, int index, int jndex)
{
	char	*res;
	int		len;
...
static inline char	*ft_create_buffer(char *buffer, int buff_size, int fd,
		int *index)
{
	char	*temp;
